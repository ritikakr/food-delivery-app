// handles how to state should change based on dispatch actions
...
// b.ratings here ratings is taken from the mongodb data
// numOfReview also takern from the data of mongodb
...
// state is spread operator it will create new object with all previous
// indicated in process so its loading is true=====request is in process  
// error null---when request is created then there should be no error
