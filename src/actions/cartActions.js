...
import { ADD_TO_CART, 
    ...
    REMOVE_ITEM_CART,
     ...
     UPDATE_DELIVERY_INFO} from "../constants/cartConstant";
...
export const saveDeliveryInfo=(deliveryInfo)=>(dispacth)=>{
   dispacth({type:SAVE_DELIVERY_INFO,payload:deliveryInfo});}
